...
namespace WinFormsApp2.Extensions
{
    ...
    {
        public static System.Drawing.Color PrimaryColor { get; set; }
        ...
        public static System.Windows.Media.Color ChangeColorBrightnessMedia(System.Windows.Media.Color color, double correctionFactor)
        {
            double red = color.R;
            double green = color.G;
            double blue = color.B;
